...
from BigB2BSpider.items import XiBeiMiaoMuWangItem
# from scrapy_redis.spiders import RedisCrawlSpider
from scrapy.cmdline import execute



class XiBeiMiaoMuWangSpider(CrawlSpider):
    name = "xbmiaomu"
    allowed_domains = ['www.xbmiaomu.com','xbmiaomu.com']
    start_urls = ['http://www.xbmiaomu.com/company/']
    cw = CleanWords()
    ...
    rules = (
        Rule(LinkExtractor(
            allow=r".*",restrict_xpaths=("//ul[@class='compary_list_ul']//li//h3//a")),follow=True),
