...
class ErSanSanGongChangWangSpider(CrawlSpider):
    name = "ec233"
    allowed_domains = ['ec233.com','www.ec233.com']
    start_urls = ['http://www.ec233.com/company/']
    cw = CleanWords()
    ...
    rules = (
        Rule(LinkExtractor(
            allow=r".*",restrict_xpaths=("//div[@class='m3l o_h']//div[contains(@class,'list')]//a")),follow=True),

        Rule(LinkExtractor(
            allow=r".*", restrict_xpaths=(
                "//div[@class='m2l']//div[@class='list']//td[@align='left']//li//a")),follow=True),
