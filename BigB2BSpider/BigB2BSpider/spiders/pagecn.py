...
from BigB2BSpider.items import QiYeHuispiderItem
from BigB2BSpider.data_tools.orc_img import recognition_image
from scrapy.cmdline import execute



class QiYeHuiSpider(CrawlSpider):
    name = 'pagecn'
    allowed_domains = ['www.pagecn.net']
    start_urls = ['http://www.pagecn.net/company/']
    cw = CleanWords()
    ...
    def parse_company_contact(self, response):
        headers = {
            ...
            "Cache-Control": "max-age=0",
            "Connection": "keep-alive",
            "Cookie": "bdshare_firstime=1564968865859; Hm_lvt_c7894de9c1e0658a1d1ab0f838038a41=1565570819; UM_distinctid=16c834ae3896b4-0c696e87b00aaf-5a13331d-1fa400-16c834ae38a91; CNZZDATA4515303=cnzz_eid%3D296075593-1565569508-http%253A%252F%252Fwww.pagecn.net%252F%26ntime%3D1565569508; Hm_lpvt_c7894de9c1e0658a1d1ab0f838038a41=1565571119",
            "Host": "www.pagecn.net",
