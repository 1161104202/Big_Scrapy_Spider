...
from BigB2BSpider.items import GongQiuXingXiWangItem
...
class GongQiuXingXiWangSpider(CrawlSpider):
    ...
    rules = (
        Rule(LinkExtractor(
            allow=r".*",restrict_xpaths=("///div[@class='list-cate']//td//a")),follow=True),

        Rule(LinkExtractor(
            allow=r".*", restrict_xpaths=("//div[@class='m m2']//div[@class='list']//td[@align='left']//li//a")),follow=True),
