...
from BigB2BSpider.items import QiLingWangItem
...
class QiLingWangSpider(CrawlSpider):
    ...
    def parse_items(self, response):
        ...
        item["kind"] = response.xpath("//p[contains(text(),'主营：')]/text()").extract_first()
        item["company_address"] = response.xpath("//div[@class='side']//li[contains(text(),'地址：')]/text()").extract_first()
