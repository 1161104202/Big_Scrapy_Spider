...
from BigB2BSpider.items import QiZhangWangspiderItem
from BigB2BSpider.data_tools.orc_img import recognition_image
from scrapy.cmdline import execute



class QiZhangWangSpider(CrawlSpider):
    name = 'jzqncy'
    allowed_domains = ['jzqncy.com','www.jzqncy.com']
    start_urls = ['http://www.jzqncy.com/qiyew/']
    cw = CleanWords()
