...
from BigB2BSpider.items import ZhongGuoDianbQiItem
# from scrapy_redis.spiders import RedisCrawlSpider
from scrapy.cmdline import execute



class ZhongGuoDianbQiSpider(CrawlSpider):
    name = "cndqzd"
    allowed_domains = ['www.cndqzd.com','cndqzd.com']
    start_urls = ['https://www.cndqzd.com/company/']
    cw = CleanWords()
    ...
    rules = (
        ...
        Rule(LinkExtractor(
            allow=r".*", restrict_xpaths=(
                "//div[@class='product_list']//div[@class='company2']//h1//a")),follow=True),
        ...
        Rule(LinkExtractor(
            allow=r".*",restrict_xpaths=(
                "//div[@class='menu']//span[contains(text(),'联系方式')]/..")), callback='parse_items', follow=True),

    )

    def parse_items(self, response):
        item = ZhongGuoDianbQiItem()
